...
namespace RTSLockstep.Data
{
    ...
    , IAgentControllerDataProvider, IWorldObjectDataProvider
    {
        ...
        protected AgentDataItem[] _agentData;
        ...
        [SerializeField]
        //This data is registered for editing in the database editor
        [RegisterData("WorldObjects")]
        protected WorldObjectDataItem[] _worldObjectData;

        //Using IDE reference finding, you can see how the stored _agentData gets passed on to the simulation
        public IWorldObjectData[] WorldObjectData { get { return _worldObjectData.Cast<IWorldObjectData>().ToArray(); } }
        #endregion
        ...
        protected EffectDataItem[] _effectData;
        ...
        protected AbilityDataItem[] _abilityData;
        ...
        #region Avatars
        [SerializeField, RegisterDataAttribute("Avatars")]
        protected AvatarDataItem[] _avatarData;
        public AvatarDataItem[] AvatarData { get { return _avatarData; } }
        #endregion

        #region Agent Controller
