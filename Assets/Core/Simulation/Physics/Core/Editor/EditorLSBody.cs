...
namespace RTSLockstep.Integration
{
    ...
    public class EditorLSBody : Editor
    {
        ...
        void OnEnable()
        {
            ...
            HalfLength = so.FindProperty("_internalBody").FindPropertyRelative("_halfLength");
                ...
                */
                ...
                else if (shape == ColliderType.AABox)
                {
                    ...
                    float newLength =
                        System.Math.Abs(
                            Handles.FreeMoveHandle(
                                new Vector3(targetPos.x, targetPos.y, targetPos.z - (float)HalfLength.longValue.ToFormattedDouble()),
                                Quaternion.identity,
                                MoveHandleSize,
                                Vector3.zero,
                                dragCap)
