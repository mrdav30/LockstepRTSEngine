...
namespace RTSLockstep
{
    public class CollisionPair
    {
        ...
        private static bool IsCollidingChanged;
        ...
        private static long dist, depth;
        ...
        private static long xDist;
        private static long yDist;
        private static bool xMore;
        private static bool yMore;
        private static bool Collided;
        private static long xAbs, yAbs;
            ...
            if (CullCounter <= 0)
            {
                ...
                if (!IsColliding)
                {
                    ...
                    if (CullCounter >= 0)
                    {
                        ...
                        {
                            CullCounter = (short)((LockstepManager.FrameCount - LastCollidedFrame) / PhysicsManager.CullTimeStep);
                        ...
                        else
                        {
                            ...
                            var distCull = (((FastDistance - FastDistanceOffset) >> FixedMath.SHIFT_AMOUNT)
        ...
        {
            if (!Body1.PositionChangedBuffer && !Body2.PositionChangedBuffer
                && !Body1.RotationChangedBuffer && !Body2.RotationChangedBuffer)
            {
                return IsColliding;
            }
        ...
        private static bool CheckCircle_Poly(LSBody circle, LSBody poly)
        {
            ...
            for (int i = 0; i < EdgeCount; i++)
            {
                ...
                ProjectPolygon(axis.x, axis.y, poly, out long PolyMin, out long PolyMax);
        ...
        public static bool CheckPoly_Poly(LSBody poly1, LSBody poly2)
        {
            ...
            for (int i = 0; i < EdgeCount; i++)
            {
                ...
                ProjectPolygon(edge.x, edge.y, poly1, out long Poly1Min, out long Poly1Max);
                ProjectPolygon(edge.x, edge.y, poly2, out long Poly2Min, out long Poly2Max);
