...
namespace RTSLockstep.Networking
{
    public abstract class NetworkHelper : MonoBehaviour
    {
        ...
        {
            throw new System.NotImplementedException("Connecting not supported for " + ToString() + ".");
        }
        ...
        {
            throw new System.NotImplementedException("Hosting not supported for " + ToString() + ".");
        }
