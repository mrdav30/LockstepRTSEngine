...
namespace RTSLockstep
{
    ...
    public class LSAgent : MonoBehaviour, IMousable
    {
        ...
        private readonly int _deathTime = LockstepManager.FrameRate * 2;
        ...
        //not sure why this is hidden from inspector
        ...
        [SerializeField]
        private readonly int _boxPriority = 0;
        public int BoxPriority { get { return _boxPriority; } }

        [SerializeField]
        private readonly int _selectionPriority = 0;
        public int SelectionPriority { get { return _selectionPriority; } }

        [SerializeField]
        private readonly bool _selectable = true;
       ...
       // bool Setuped; //Not used anywhere
